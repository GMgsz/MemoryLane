...
class PromptTemplateBuilder:
    ...
    def build(
        ...
        # 如果有template_path，读取模板内容
        if "template_path" in config:
            template_path = os.path.join(self.prompt_path, config["template_path"])
            ...
            # 如果没有template_path，使用原有的load_prompt
            main_prompt_template = load_prompt(main_file)
